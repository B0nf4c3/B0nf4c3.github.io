...
```sh
	 searchsploit fuel
```
![[Pasted image 20241028200419.png]]

Downloaded the exploit to my machine.  
```sh
	searchsploit -m 47138.py
```
![[Pasted image 20241028200429.png]]
...
nc -nlvp 1337
```
![[Screenshot From 2024-10-28 19-55-29.png]]
